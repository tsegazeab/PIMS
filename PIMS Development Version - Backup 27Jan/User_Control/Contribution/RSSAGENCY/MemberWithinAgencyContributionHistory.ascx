<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MemberWithinAgencyContributionHistory.ascx.cs" Inherits="User_Control_Contribution_RSSAGENCY_MemberWithinAgencyContributionHistory" %>
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
        ...
        <telerik:GridBoundColumn FilterControlAltText="Filter column9 column" 
            HeaderText="Pension ID" UniqueName="column9">
        </telerik:GridBoundColumn>
