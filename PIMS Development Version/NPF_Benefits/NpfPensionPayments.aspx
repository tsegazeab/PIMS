<%@ Page Title="NPF Pensioners - PIMS" Language="C#" MasterPageFile="~/MasterPageNpfBenefit.master" AutoEventWireup="true" CodeFile="NpfPensionPayments.aspx.cs" Inherits="NPF_Benefits_NpfPensionPayments" %>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <telerik:RadButton ID="RadButtonProcessPayments" runat="server" Skin="Vista" 
                                                Text="Process" onclick="RadButtonProcessPayments_Click" 
                                                ValidationGroup="ProcessPayment">
                                            </telerik:RadButton>
                                        </td>
                                    </tr>
