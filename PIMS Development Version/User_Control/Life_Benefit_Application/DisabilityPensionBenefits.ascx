<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DisabilityPensionBenefits.ascx.cs" Inherits="User_Control_Life_Benefit_Application_DisabilityPensionBenefits" %>
...
<div id="benefitCalculation">
    <table cellpadding="4" cellspacing="0" width="650" class="benefitsDisplayTab" align="center">
        <tr>
            <td colspan="3">
                <asp:Label ID="Label19" runat="server" Text="DISABILITY PENSION" 
        ...
        <tr>
            <td>&nbsp;</td>
            <td valign="top">
                <asp:Label ID="Label20" runat="server" Text="Date of Disability:" 
                    CssClass="text"></asp:Label>
              </td>
            <td align="right" valign="top">
                <asp:Label ID="LabelDateOfDisability" runat="server" 
                    CssClass="text" Font-Bold="False"></asp:Label>
            </td>
            <td>&nbsp;</td><td>&nbsp;</td>
        </tr>
        ...
        <tr>
            <td>&nbsp;</td>
            <td valign="top">
                <asp:Label ID="Label24" runat="server" Text="First of Month Following Disability" 
                    CssClass="text"></asp:Label>
              </td>
            <td align="center" valign="top" bgcolor="#CCCC00" colspan="2">
        ...
        <tr>
            <td>&nbsp;</td>
            <td valign="top" colspan="2">
                Gross Pension Accrued in Year of Disability</td>
            <td align="right" bgcolor="#CCCC00">
...
<table cellpadding="4" cellspacing="0" width="650" align="center" align="center">
    <tr>
