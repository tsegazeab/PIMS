<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SurvivorBenefits.ascx.cs" Inherits="User_Control_Life_Benefit_Application_SurvivorBenefits" %>
...
<div id="benefitCalculation">
    <table cellpadding="4" cellspacing="0" width="650" align="center" class="benefitsDisplayTab">
        <tr>
            <td colspan="3">
                <asp:Label ID="Label19" runat="server" Text="DEATH IN SERVICE PENSION" 
        ...
        <tr>
            <td>&nbsp;</td>
            <td valign="top">
                <asp:Label ID="Label20" runat="server" Text="Date of Death:" 
                    CssClass="text"></asp:Label>
              </td>
            <td align="right" valign="top">
                <asp:Label ID="LabelDateOfDeath" runat="server" 
                    CssClass="text" Font-Bold="False"></asp:Label>
            </td>
            <td>&nbsp;</td><td>&nbsp;</td>
        </tr>
        ...
        <tr>
            <td>&nbsp;</td>
            <td valign="top">
                <asp:Label ID="Label14" runat="server" Text="Projected Age at Retirement" 
                    CssClass="text"></asp:Label>
              </td>
            <td align="center" valign="top" bgcolor="#CCCC00" colspan="2">
                <asp:Label ID="LabelProjectedAgeAtRetirement" runat="server" 
                    CssClass="text" Font-Bold="True"></asp:Label>
            </td>
            <td align="right">
                &nbsp;</td>
        ...
        <tr>
            <td>&nbsp;</td>
            <td valign="top">
                <asp:Label ID="Label24" runat="server" Text="First of Month Following Death" 
                    CssClass="text"></asp:Label>
              </td>
            <td align="center" valign="top" bgcolor="#CCCC00" colspan="2">
                <asp:Label ID="LabelFirstOfFollowingMonth" runat="server" 
                    CssClass="text" Font-Bold="True"></asp:Label>
            </td>
            <td align="right">
                &nbsp;</td>
        ...
        <tr>
            <td>&nbsp;</td>
            <td valign="top">
                <asp:Label ID="Label15" runat="server" Text="Projected Retirement Date" 
                    CssClass="text"></asp:Label>
              </td>
            <td align="center" valign="top" bgcolor="#CCCC00" colspan="2">
                <asp:Label ID="LabelProjectedRetirementDate" runat="server" 
                    CssClass="text" Font-Bold="True"></asp:Label>
            </td>
            <td align="right">
                &nbsp;</td>
        ...
        <tr>
            ...
            <td valign="middle" rowspan="2">
                Projected Remaining Service</td>
            <td align="center" valign="top" bgcolor="#CCCC00" colspan="2">
                <asp:Label ID="LabelProjectedRemainingService" runat="server" 
                    CssClass="text" Font-Bold="True"></asp:Label>
            </td>
            <td align="right">
                &nbsp;</td>
        ...
        <tr>
            <td>&nbsp;</td>
            <td align="center" valign="top" bgcolor="#CCCC00" colspan="2">
                <asp:Label ID="LabelProjectedRemainingServiceYears" runat="server" 
                    CssClass="text" Font-Bold="True"></asp:Label>
            </td>
            <td align="right">
                &nbsp;</td>
        ...
        <tr>
            ...
            <td align="right" bgcolor="#CCCC00">
                <asp:Label ID="LabelDisabilityYearGrossSalary" runat="server" 
                    CssClass="text" Font-Bold="True"></asp:Label>
            </td>
            <td align="right">
                &nbsp;</td>
        ...
        <tr>
            <td>&nbsp;</td>
            <td valign="top" colspan="2">
                Gross Pension Accrued in Year of Death</td>
            <td align="right" bgcolor="#CCCC00">
        ...
        <tr>
            <td>&nbsp;</td>
            <td valign="top" colspan="2">
                Projected Annual Pension</td>
            <td align="right" bgcolor="#CCCC00">
                <asp:Label ID="LabelProjectedAnnualPension" runat="server" 
                    CssClass="text" Font-Bold="True"></asp:Label>
            </td><td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td valign="top" colspan="2">
                &nbsp;&nbsp; =[<asp:Label 
                    ID="LabelProjectedAnnualPensionFormula" runat="server" 
                    CssClass="text" Font-Bold="False"></asp:Label>
                ]</td>
            <td align="right">
                &nbsp;</td><td>&nbsp;</td>
        ...
        <tr>
            <td colspan="3">
                <asp:Label ID="Label23" runat="server" Text="BENEFIT AMOUNT" 
                    CssClass="text" Font-Bold="True" Font-Size="Large"></asp:Label>
              </td>
            <td>&nbsp;</td><td>&nbsp;</td>
        </tr>
        ...
        <tr>
            <td colspan="3">
                <asp:Label ID="Label25" runat="server" Text="SURVIVOR BENEFITS" 
                    CssClass="text" Font-Bold="True" Font-Size="Large"></asp:Label>
              </td>
            <td>&nbsp;</td><td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td valign="top" align="left" colspan="3">
                <asp:GridView ID="GridViewSurvivorBenefits" runat="server" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="BenefitAmount" DataFormatString="{0:#,##0.00}" 
                            HeaderText="Benefit Amount">
        ...
        <tr>
            ...
            <td valign="top" align="right" colspan="4">
                <telerik:RadButton ID="RadButtonSaveBenefit" runat="server" Skin="Vista" 
                    Text="Save Benefit" onclick="RadButtonSaveBenefit_Click" Visible="False">
                </telerik:RadButton>
            </td>
        </tr>
    </table>
