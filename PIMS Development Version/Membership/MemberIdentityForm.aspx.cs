...
public partial class Membership_MemberIdentityForm : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            MemberIdentity1.PensionID = Master.PensionID;
            //MemberIdentity1.DisplayMemberNameAndPensionID(int.Parse(Master.PensionID));
            MemberIdentity1.DisplayMemberNameAndPensionID(int.Parse(PSPITSModuleSession.PensionID.Trim()));
        }
    }
